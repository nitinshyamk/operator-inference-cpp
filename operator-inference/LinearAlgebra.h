...
public:
	...
	/// <summary>
	/// returns a new matrix generated by taking the subset of rows and columns
	///	 described by row_range and column_range implied by A
	/// </summary>
	/// <param name="A"></param>
	...
	/// Returns A^T
	/// </summary>
	cuda_gpu_matrix transpose(const cuda_gpu_matrix& A, bool forceDeepCopy = true) const;

	/// <summary>
	/// Solves the linear regression Ax = b for x with L2/tikhonov regularization penalty
	/// </summary>
	/// <param name="A"></param>
	/// <param name="b"></param>
	/// <param name="k"></param>
	...
	{
		svd decomposition = svd_decomposition(A);
		return pinv(decomposition);
	}
